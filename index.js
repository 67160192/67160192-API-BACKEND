...
const app = express();
const PORT = process.env.PORT || 3000; //.env ตั้งport อะไรไว้มันจะเป็ยชื่อ port 
...
// 2. GET: ดึงข้อมูลนักศึกษารายบุคคลจากฐานข้อมูล
...
// 3. POST: เพิ่มข้อมูลนักศึกษาใหม่ลงฐานข้อมูล
